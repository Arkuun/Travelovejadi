...
@section('main')
  ...
  <div class="intro">
    <div class="container">
      <div class="row">
        <div class="col">
          <h2 class="intro_title text-center">Destinasi Terbaik Di Banyumas</h2>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-10 offset-lg-1">
          <div class="intro_text text-center">
            <p>Jelajahi dan Bagikan Momenmu</p>
          </div>
        </div>
      </div>
      ...
      <div class="row trending_container">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="trending_item clearfix">
            <div class="trending_image"><img src="media/event/event_87554.jpg" alt="https://unsplash.com/@fransaraco"></div>
            <div class="trending_content">
              <div class="trending_title"><a href="#">ASASASA</a></div>
